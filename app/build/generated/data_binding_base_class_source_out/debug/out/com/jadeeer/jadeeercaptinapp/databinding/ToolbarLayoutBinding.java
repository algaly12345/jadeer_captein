...
public final class ToolbarLayoutBinding implements ViewBinding {
  ...
  private ToolbarLayoutBinding(@NonNull Toolbar rootView, @NonNull Switch onOffSwitch,
  ...
  public static ToolbarLayoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.on_off_switch;
      Switch onOffSwitch = ViewBindings.findChildViewById(rootView, id);
      if (onOffSwitch == null) {
        break missingId;
      }
      ...
      return new ToolbarLayoutBinding((Toolbar) rootView, onOffSwitch, toolbar);
    }
