...
public final class FragmentOrdersBinding implements ViewBinding {
  ...
  private FragmentOrdersBinding(@NonNull LinearLayout rootView, @NonNull CardView cardEmail,
  ...
  public static FragmentOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentOrdersBinding((LinearLayout) rootView, cardEmail, cardLogout, cardPassword,
          email, imgCamera, imgProfile, txtEEmail, txtEmail, txtUsername);
    }
